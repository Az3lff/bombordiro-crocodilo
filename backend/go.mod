module github.com/Az3lff/bombordiro-crocodilo

go 1.24.2

replace github.com/Az3lff/bombordiro-crocodilo/pkg => ./pkg/

require (
	github.com/Az3lff/bombordiro-crocodilo/pkg v0.0.0-00010101000000-000000000000
